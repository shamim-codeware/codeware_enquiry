...
// Main Pie Nipun 
function pieChart(e, t, o, r = "100") {
    var a = {
        series: t,
        labels: ["Open", "Sales", "Close", "Pending"],
        colors: ["#ffa500", "#008000", "#ff0000", "#FF8244"],
        chart: { type: "pie", group: "social", width: o, height: 150 },
        legend: {
            show: !1,
            position: "bottom",
        ...
        i = {
            ...
            events: [
                ...
                },
                {
                    ...
                    title: "Enquiry Management System - Rangs",
                },
            ],
            className: "warning",
            textColor: "#FA8B0C",
...
!(function (e) {
    ...
    e(".table-responsive--dynamic .dropdown").on(
        ...
        e("#datepicker8").datepicker({ dateFormat: "dd-mm-yy" }),
          e("#datepicker17").datepicker({dateFormat: "dd-mm-yy"}),
    ...
    p.classList.add("overlay-dark"),
        ...
        e("#show_room_id").select2({
            placeholder: "All Showroom",
            allowClear: !0,
        }),
        e("#source_id").select2({
            placeholder: "All",
    ...
    q &&
        ...
        e("#select-parent-source").select2({
            placeholder: "Select Parent Source",
            dropdownCssClass: "alert2",
            allowClear: !0,
        }),
        e("#select-parent-enquiry").select2({
            placeholder: "Select Parent Status",
            dropdownCssClass: "alert2",
            allowClear: !0,
        }),
        e("#select-status-type").select2({
        ...
        e("#select-tag").select2({
            placeholder: "Zone",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        e("#select-division").select2({
            placeholder: "Zone",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        e("#select-thana").select2({
            placeholder: "Zone",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        e("#select-district").select2({
            placeholder: "Zone",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        // e("#select-model").select2({
        ...
        e("#Select-Enquiry-Type").select2({
            placeholder: "Enquiry Type",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#Select-Age-Group").select2({
            placeholder: "Enquiry Type",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        e("#Select-awareness").select2({
            placeholder: "Source of awareness",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#select-buying-aspect").select2({
            placeholder: "Buying Aspect",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#select-showroom").select2({
            placeholder: "All Show Room",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
         e("#select-customer").select2({
            placeholder: "All Customer",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#select-executive").select2({
            placeholder: "Select Executive",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#customer_profession").select2({
            placeholder: "Select Customer Profession",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#customer_type").select2({
        ...
        e("#Select-follower").select2({
            placeholder: "select source",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#Select-upazila").select2({
            placeholder: "select Upazila/Thana",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#select-show-rooms").select2({
            placeholder: "select Show Room",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#select-role").select2({
        ...
        e("#select-group").select2({
            placeholder: "Select Group Name",
            dropdownCssClass: "tag",
            allowClear: !0,
        }),
        e("#select-district-filter").select2({
            placeholder: "Select District",
            dropdownCssClass: "tag",
            allowClear: !0,
        }),
        ...
        e("#status_month").select2({
            placeholder: "Select Month",
            dropdownCssClass: "tag",
            allowClear: !0,
        }),
        e("#Select-zone").select2({
            placeholder: "Select Zone",
            dropdownCssClass: "tag",
            allowClear: !0,
        }),
        e("#Select-exchange-offer").select2({
            placeholder: "Want to know Exchange offer",
            dropdownCssClass: "tag",
            tags: ["Yes", "No"],
            allowClear: !0,
        }),
        e("#select-Purchase-mode").select2({
            placeholder: "Purchase Mode",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        e("#parent_status").select2({
            placeholder: "",
            dropdownCssClass: "tag",
            // tags: ["Cold", "Hot", "Warm"],
            allowClear: !0,
        ...
        e("#select-buyer").select2({
            placeholder: "Item Model",
            dropdownCssClass: "tag",
            tags: ["1st", "2nd", "3rd", "others"],
            allowClear: !0,
        }),
        e("#select-test-ride").select2({
            placeholder: "Test Ride",
            dropdownCssClass: "tag",
            tags: ["1st", "2nd", "3rd", "others"],
            allowClear: !0,
        }),
        e("#select-brand-model").select2({
            placeholder: "Model",
            dropdownCssClass: "tag",
            tags: ["Option 1", "option 2"],
            allowClear: !0,
        }),
        e("#Select-gender").select2({
            placeholder: "Gender",
            dropdownCssClass: "tag",
            tags: ["Male", "Female", "Others"],
            allowClear: !0,
        }),
        e("#select-customer-type").select2({
            placeholder: "Customer Type",
            dropdownCssClass: "tag",
            tags: ["Individual", "Corporate", "Others"],
            allowClear: !0,
        }),
        e("#Select-color").select2({
            placeholder: "Select Product",
            dropdownCssClass: "tag",
            // tags: ["Red", "Black", "Others"],
            // allowClear: !0,
        }),
        e("#select-Type").select2({
        ...
        e("#select-Type-1").select2({
            placeholder: "Payment Type",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e(".next_follow_up_method").select2({
            placeholder: "Follow-Up Method",
            dropdownCssClass: "tag",

            allowClear: !0,
        }),
        e("#select-brand").select2({
            placeholder: "Brand",
            dropdownCssClass: "tag",
            tags: ["TVS", "others"],
            allowClear: !0,
        ...
        e("#select-tag2").select2({
            placeholder: "Teritory",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
        }),
        e("#select-tag3").select2({
            placeholder: "Dealer",
            dropdownCssClass: "tag",
            tags: ["red", "green", "blue"],
            allowClear: !0,
