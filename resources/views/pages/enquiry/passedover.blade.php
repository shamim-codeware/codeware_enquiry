                        ...
                        <div class="card card-default card-md mb-4">
                            <div class="card-header">
                                <div class="d-flex flex-wrap align-items-center">
                                    <h6>Passed Over Follow Up Enquiry</h6>
                                    <div id="export"></div>
                                </div>                            
                            </div>
                            {{-- Passed Filter  --}}
...
<script type="text/javascript">
    ...
    function getData(page, event)
    {
        ...
        $.ajax({
            url: "{{ url('passed-over-enquiries?page=') }}"+page +"&"+paramStrings.join('&'),
            type: "get",
            datatype: "html",
        })
        .done(function(data){
        ...
        var custome = "{{ url('passed-over-enquiries-export?page=') }}"+page +"&"+paramStrings.join('&');
