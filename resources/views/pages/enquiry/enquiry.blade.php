...
@section('content')
                                ...
                                <div class="card card-default card-md mb-4">
                                    <div class="card-header">
                                        ...
                                        <div class="d-flex gap-2">
                                            <a class="btn btn-primary" href="{{ url('import/enquiry') }}">Import </a>
                                            <a href="{{ route('enquiry.index') }}" class="btn btn-primary">Manage
                                                Enquiry</a>
                                        </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group row row-cols-lg-4 row-cols-1">
                                                            ...
                                                            <div class="col mb-25">
                                                                <div class="select-style2">
                                                                    <div class="dm-select req">
                                                                        <select onchange="findExecutive()" required
                                                                            name="showroom_id" id="select-showroom"
                                                                            class="form-control ">
                                                                            <option value=""></option>
                                                        ...
                                                        <div class="col mb-25">
                                                            <div class="select-style2">
                                                                <div class="dm-select req">
                                                                    <select required name="assign" id="select-executive"
                                                                        class="form-control ">
                                                                        <option value="">Select Executive
                                                                            <span>*</span></option>
                                            ...
                                            <fieldset class="mt-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 mb-25">
                                                        <div class="holder">
                                                            <div class="input-holder">
                                                                <input required onkeyup="CheckNumber()" name="number"
                                                                    id="number" class="input" type="number"
                                                                    placeholder="+880123456789">
                                                                <div class="placeholder">
                                                                    <p class="m-0">Mobile <span
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class="holder">
                                                            <div class="input-holder">
                                                                <input name="alt_number" id="alt_number" class="input"
                                                                    type="number" placeholder="+880123456789">
                                                                <div class="placeholder">
                                                                    <p class="m-0">Alternative Mobile</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class=" select-style2">
                                                            <div class="dm-select req">
                                                                <select id="customer_profession" name="profession"
                                                                    id="select-customer-type" class="form-control ">
                                                                    {{-- <option value="">*</option> --}}
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class=" select-style2">
                                                            <div class="dm-select req">
                                                                <select id="customer_type" name="type_id"
                                                                    class="form-control ">
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class=" select-style2">
                                                            <div class="dm-select ">
                                                                <select onchange="FindDistrict()" name="district_id"
                                                                    id="select-district" class="form-control ">
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class=" select-style2">
                                                            <div class="dm-select ">
                                                                <select name="upazila_id" id="Select-upazila"
                                                                    class="form-control ">
                                                ...
                                                <div class="form-group row row-cols-lg-4 row-cols-1">
                                                    <div class="col mb-25">
                                                        <div class="select-style">
                                                            <div class="dm-select req">
                                                                <select required onchange="Source()" name="source_parent"
                                                                    id="Select-awareness" class="form-control ">
                                                                    <option value="">Source of awareness*</option>
                                                                    @foreach ($sources_awerness as $key => $sources_awerne)
                                                                        <option value="{{ $sources_awerne->id }}">
                                                                            {{ $sources_awerne->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col mb-25" id="source" style="display: none">
                                                        <div class="select-style2">
                                                            <div class="dm-select ">
                                                                <select required name="source_child" id="Select-follower"
                                                                    class="form-control ">
                                                    ...
                                                    <div class="col mb-25">
                                                        <div class="select-style2">
                                                            <div class="dm-select req">
                                                                <select required name="buying_aspect"
                                                                    id="select-buying-aspect" class="form-control ">
                                                    ...
                                                    <div class="col mb-25">
                                                        <div class=" select-style2">
                                                            <div class="dm-select req">
                                                                <select required name="purchase_mode" id="select-Type-1"
                                                                    class="form-control purchase_mode">
                                                                    <option value="">Purchase Mode</option>
                                                                    @foreach ($purchasemods as $key => $purchasemod)
                                                                        <option value="{{ $purchasemod->id }}">
                                                                            {{ $purchasemod->name }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class=" select-style2">
                                                            <div class="form-control d-flex gap-3 align-items-center">
                                                                ...
                                                                <div onclick="no()" id="no">
                                                                    <input name="offer" value="0" checked
                                                                        type="radio"> <label for="no">No</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div id="Offerpage" class="col mb-25 custom-height"
                                                        style="display: none;">
                                                        <div class="wrapper-block card p-2">
                                                            <div class="col-lg-4">
                                                                <div class="d-flex gap-1">
                                                                    <input id="Exchange" name="type_of_offer[]"
                                                                        value="Exchange" type="checkbox">
                                                                    <label class="text-dark"
                                                                        for="Exchange">Exchange</label>
                                                                </div>

                                                            </div>
                                                            <div class="col-lg-2">
                                                                <div class="d-flex gap-1">
                                                                    <input name="type_of_offer[]" id="EMI"
                                                                        type="checkbox" value="EMI">
                                                                    <label class="text-dark" for="EMI">EMI</label>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4">
                                                                <div class="d-flex gap-1">
                                                                    <input name="type_of_offer[]" id="Discount"
                                                                        value="Discount" type="checkbox">
                                                                    <label class="text-dark"
                                                            ...
                                                            <div class="col-lg-2">
                                                                <div class="d-flex gap-1">
                                                                    <input value="Gift" name="type_of_offer[]"
                                                                        id="Gift" type="checkbox">
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class="holder">
                                                            <div class="input-holder">
                                                                <input required name="remarks" id="remarks"
                                                                    class="input" type="text">
                                                                <div class="placeholder">
                                                                    <p class="m-0">Customer Opinion </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <fieldset class="mt-2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 mb-25">
                                                        <div class="">
                                                            <div class="">
                                                                <select name="category" id="Select-Model"
                                                                    onchange="GetProduct()" class="form-control category">
                                                                </select>
                                                    ...
                                                    <div class="col-md-4 mb-25">
                                                        <div class=" select-style2">
                                                            <div class="dm-select ">
                                                                <select name="product" id="Select-color"
                                                                    class="form-control ">
                                                    ...
                                                    <div class="col-md-2 mb-25">
                                                        <button type="button" onclick="AddItem()"
                                                            class="btn btn-primary w-30">Add Item</button>
                                                    </div>
                                                    <div class="col-12">
                                                                ...
                                                                <table class="table mb-0 table-bordered">
                                                                    <thead>
                                                                        <tr class="userDatatable-header">
                                                                            ...
                                                                            <th>
                                                                                <span class="userDatatable-title">Group
                                                                                </span>
                                                                            </th>
                                                                            <th>
                                                                                <span
                                                                                    class="userDatatable-title">Category</span>
                                                                            </th>
                                                                            <th>
                                                                                <span class="userDatatable-title">Product
                                                                                    Name
                                                                                </span>
                                                                            </th>
                                                                            <th>
                                            ...
                                            <fieldset class="mt-2">
                                                ...
                                                <div class="row row-cols-1 row-cols-lg-5">
                                                    <div class="col-md-3">
                                                        <div class="with-icon position-relative">
                                                            ...
                                                            <div class="form-group req1 form-group-calender mb-20">
                                                                <input type="text" name="next_follow_up_date"
                                                                    placeholder="Follow-up date & time"
                                                                    class="flatpickr form-control" required>
                                                            </div>
                                                            {{-- <span style="top: 25px;
                                                    ...
                                                    <div class="col mb-25">
                                                        <div class="select-style2">
                                                            <div class="dm-select">
                                                                <select required name="next_follow_up_method"
                                                                    class="form-control next_follow_up_method">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.post(url, {
                ...
                data.forEach(item => {
                    ...
                    .id; // Replace 'item.value' with the actual data field
        ...
        function AddItem() {
            ...
            $("#group-require").html("");
            addTableRow(
                count, '<input type="hidden" name="group_name[]" value="' + groupt[0] +
                '"><input type="hidden" name="group_id[]" value="' + groupt[1] + '">' + groupt[0],
                '<input type="hidden" name="category_name[]" value="' + cat_info[0] +
                '"><input type="hidden" name="category_id[]" value="' + cat_info[1] + '">' + cat_info[0],
                '<input type="hidden" name="product_name[]" value="' + product_with_id[0] +
                '"><input type="hidden" name="product_id[]" value="' + product_with_id[1] + '">' + product_with_id[0],
                '<div class="d-flex"><button type="button" title="edit" onclick="deleteTableRow(' + count +
                ')" class="remove"><i class="uil uil-trash-alt"></i></button></div>'
            );
            count++;
