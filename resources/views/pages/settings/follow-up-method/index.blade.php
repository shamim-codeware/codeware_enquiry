                        ...
                        <div class="card card-default card-md mb-4">
                            @if (Auth::user()->user_action(1))
                                <div class="card-header">
                                    <h6>Create Follow Up Method</h6>
                                </div>
                                <div class="card-body py-md-30">
                                    <form action="{{ url('follow-up-method') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group row mb-n25">
                                            <div class="col-md-4 mb-25">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="text" required name="name" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" placeholder="New Follow Up Method">
                                                </div>
                                            </div>
                        ...
                        <div class="row row-cols-3 w-100">
                            ...
                            <div class="col d-flex justify-content-end "> <div class="support-form__search">
                                <div class="support-order-search">
                                    <form action="{{ url('follow-up-method') }}" method="get" class="support-order-search__form">
                            ...
                            <table class="table mb-0 table-borderless">
                                <thead>
                                    <tr class="userDatatable-header">
                                        ...
                                        <th>
                                            <span class="userDatatable-title">Follow Up Method</span>
                                        </th>
                                        ...
                                        <td>
                                            <ul class="orderDatatable_actions mb-0 d-flex justify-content-center align-items-center flex-wrap">
                                                @if (Auth::user()->user_action(4))
                                                    <li>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Change Status" href="{{ url('follow-up-method-status/'.$type->id) }}" class="view">
                                                ...
                                                @if (Auth::user()->user_action(2))
                                                    <li>
                                                        <a data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{url('follow-up-method/'.$type->id.'/edit')}}" class="edit">
