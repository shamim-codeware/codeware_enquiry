                        ...
                        <div class="card card-default card-md mb-4">
                            @if (Auth::user()->user_action(1))
                                ...
                                <div class="card-body py-md-30">
                                    <form action="{{ url('zones') }}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group row mb-n25">
                                            <div class="col-md-4 mb-25">
                                                <div class="with-icon">
                                                    ...
                                                    <input type="text" required name="name" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" placeholder="Add Zone">
                                                </div>
                                            </div>
                        ...
                        <div class="row row-cols-3 w-100">
                            ...
                            <div class="col d-flex justify-content-end "> <div class="support-form__search">
                                <div class="support-order-search">
                                    <form action="{{ url('zones') }}" method="GET" class="support-order-search__form">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="userDatatable-content--subject">
                                                {{ $zone->users ? $zone->users->name : '' }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="userDatatable-content--priority">
                                                {{ date('d/m/Y', strtotime($zone->created_at)) }}
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <ul class="orderDatatable_actions mb-0 d-flex justify-content-center align-items-center flex-wrap">
                                                @if (Auth::user()->user_action(4))
                                                    <li>
                                                        <a  data-bs-toggle="tooltip" data-bs-placement="top" title="Change Status" href="{{ url('zone-status/'.$zone->id) }}" class="view">
                                                ...
                                                @if (Auth::user()->user_action(2))
                                                    <li>
                                                        <a  data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{url('zones/'.$zone->id.'/edit')}}" class="edit">
