                    ...
                    <div class="col-lg-12">
                        <div class="card card-default card-md mb-4">
                            ...
                            <div class="card-body py-md-30">
                                <form action="{{url('purchase-mode/'.$purchaseMode->id)}}" method="post">
                                    @method('put')
                                    @csrf 
                                    ...
                                    <div class="form-group row mb-n25">
                                        <div class="col-md-4 mb-25">
                                            <div class="with-icon">
                                                ...
                                                <input type="text" value="{{ $purchaseMode->name }}" name="name" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" placeholder="Enquiry Type">
                                            </div>
                                        </div>
