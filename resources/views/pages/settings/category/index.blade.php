                                        ...
                                        <div class="form-group row mb-n25">
                                            <div class="col-md-4 mb-25">
                                                <div class="with-icon">
                                                    ...
                                                    <input style="padding: 0 20px !important" required type="text" name="name" class="form-control px-2  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" placeholder="Product Category">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                    ...
                    <div class="userDatatable userDatatable--ticket userDatatable--ticket--2 mt-1">
                        <div class="table-responsive">
                            <table class="table mb-0 table-borderless">
                                ...
                                <tbody>
                                    @foreach($productcategories as $key=>$type)
                                    <tr>
                                        <td>{{ ($productcategories->currentpage()-1) * $productcategories->perpage() + $key + 1 }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <ul class="orderDatatable_actions mb-0 d-flex justify-content-center align-items-center flex-wrap">
                                                ...
                                                <li>
                                                    <a data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="{{url('category/'.$type->id.'/edit')}}" class="edit">
