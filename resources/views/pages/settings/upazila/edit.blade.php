                    ...
                    <div class="col-lg-12">
                        <div class="card card-default card-md mb-4">
                            <div class="card-header">
                                <h6>Update Upazila</h6>
                            </div>
                            <div class="card-body py-md-30">
                                <form action="{{url('upazila/'.$upazilas->id)}}" method="post">
                                    @method('put')
                                    @csrf 
                                    ...
                                    <div class="form-group row mb-n25">
                                            ...
                                            <div class=" select-style2">
                                                <div class="dm-select ">
                                                    <select onchange="FindDistrict()" name="district_id" id="select-district" class="form-control " required>
                                                        <option value="{{ $upazilas->district_id ? $upazilas->district_id : '' }}">{{ $upazilas->district_id ? $upazilas->district->en_name : '' }}</option>
                                        ...
                                        <div class="col-md-4 mb-25">
                                            <div class="with-icon">
                                                ...
                                                <input type="text" value="{{ $upazilas->name }}" name="name" class="form-control  ih-medium ip-lightradius-xs b-light" id="inputNameIcon1" placeholder="Enquiry Type">
                                            </div>
                                        </div>
